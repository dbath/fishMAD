...
void Go(){
  videoExport = new VideoExport(this, "stimvid_translational.mp4");
...
class Dot{
  ...
  void randomMotion() {
    ...
    this.RAD = 100.0;//sqrt(sq((this.X1 - width/2)) + sq((this.Y1-height/2)));
  ...
  void renew() {
    ...
    this.ROTATION = this.ROTATION + 100.0*this.VEL*PI/this.RAD;
